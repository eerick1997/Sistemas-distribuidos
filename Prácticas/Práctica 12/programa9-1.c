...
//socket de datagrama
//¿Qué es bzero?
//Elimina n bits iniciando por lo que apunte s

//Tamaño se var puerto 
//tamaño bits = 16, hex = 4, htons = 400

//server_addr, INTERNET, CUALQUIERA, 7200, basura
//struct msg_to_client_addr.
//Especificar el dominio y el puerto de acceso al socket.
#include <sys/types.h>
